...
namespace Task
{
    public class ZooFactory : IZooFactory
    {
        ...
        //сначала попробуйте изменить этот метод, не используя сторонних библиотек
        //потом попробуйте использовать библиотеку SexyProxy и сравните количество кода решения в обоих случаях
